...
--     ['d'] = {
--         ['name'] = '+Debug',
--         ['l']    = {'<cmd>lua require"telescope".extensions.dap.list_breakpoints{}<CR>', 'List all breakpoints'},
--         ['v']    = {'<cmd>lua require"telescope.extensions.dap.variables{}<CR>"', 'On/Off variables'},
...
--         ['B']    = {'<cmd>lua require"dap".set_breakpoint(vim.fn.input("Breakpoint condition: "))<CR>', 'Set condition breakpoint'},
--         ['L']    = {'<cmd>lua require"dap".set_breakpoint(nil, nil, vim.fn.input("Log point message: "))<CR>', 'Log point message'},
--         ['e']    = {'<cmd>lua require"dap".repl.open()<CR>', 'Open'},
--         ['x']    = {'<cmd>lua require"dap".repl.run_last()<CR>', 'Run last'},
--     },
--
--     -- Configure Neovim
--     ['n'] = {
